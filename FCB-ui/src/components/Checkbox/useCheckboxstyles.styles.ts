...
export const checkboxClassNames = {
  root: "FCB-ui-Checkbox",
  label: "FCB-ui-Checkbox__label",
  input: "FCB-ui-Checkbox__input",
  indicator: "FCB-ui-Checkbox__indicator",
};

// CSS variables used internally in Checkbox's styles
const vars = {
  indicatorColor: "--FCB-ui-Checkbox__indicator--color",
  indicatorBorderColor: "--FCB-ui-Checkbox__indicator--borderColor",
  indicatorBackgroundColor:
    "--FCB-ui-Checkbox__indicator--colorBrandForeground1",
} as const;
