...
/**
 * @internal
 * Gets the trigger element of a FcbTriggerComponent (such as Tooltip or MenuTrigger).
 *
 * In the case where the immediate child is itself a FcbTriggerComponent and/or React Fragment,
 * it returns the first descendant that is _not_ a FcbTriggerComponent or Fragment.
