...
export const cardHeaderClassNames = {
  root: "fcb-ui-CardHeader",
  image: "fcb-ui-CardHeader__image",
  header: "fcb-ui-CardHeader__header",
  description: "fcb-ui-CardHeader__description",
  action: "fcb-ui-CardHeader__action",
};
...
export const cardHeaderCSSVars = {
  cardHeaderGapVar: "--fcb-ui-CardHeader--gap",
};
